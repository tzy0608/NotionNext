...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TengAn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个暹罗猫主人兼互联网打工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tengan0608.com', // 网站地址
